...
public class Ball extends AllDirectionMovableGameObject implements BallMechanics {
     ...
     *
     * @see main.java.mvc.game.element.function.intangible.bonus.SpeedingBall
     */
     ...
     * </p>
     *
     * @see main.java.mvc.game.element.function.intangible.bonus.SpeedingBall#activate()
     */
    @Override
    public void speedUp() {
     ...
     * </p>
     *
     * @see main.java.mvc.game.element.function.intangible.bonus.SpeedingBall#deactivate()
     */
    @Override
     ...
     *
     * @see Ball#getRatioCollision(main.java.mvc.game.element.component.gameObject.movable.paddle.Paddle)
     */
    @Override
     ...
     *
     * @see main.java.mvc.game.element.function.intangible.bonus.BigBall#activate()
     * </p>
     */
    @Override
    public void sizeUp() {
     ...
     * </p>
     *
     * @see main.java.mvc.game.element.function.intangible.bonus.BigBall#deactivate()
     */
    @Override
     ...
     * @return rectangle
     *
     * @see Ball#willCollide(main.java.mvc.game.element.component.gameObject.immovable.pickup.Pickup)
     */
