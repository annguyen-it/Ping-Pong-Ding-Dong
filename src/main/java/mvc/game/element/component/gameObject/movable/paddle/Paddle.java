...
public abstract class Paddle extends VerticalOnlyMovableGameObject implements PaddleMechanics {
     ...
     * </p>
     *
     * @see main.java.mvc.game.element.function.intangible.bonus.IncreaseOwnPaddleSize#activate()
     */
    @Override
    public void sizeUp() {
        height = MAX_HEIGHT;
     ...
     * </p>
     *
     * @see main.java.mvc.game.element.function.intangible.bonus.DecreaseOpponentPaddleSize#activate()
     */
    @Override
     ...
     * </p>
     *
     * @see main.java.mvc.game.element.function.intangible.bonus.IncreaseOwnPaddleSize#deactivate()
     * @see main.java.mvc.game.element.function.intangible.bonus.DecreaseOpponentPaddleSize#deactivate()
     */
    @Override
     ...
     * </p>
     *
     * @see main.java.mvc.game.element.function.intangible.bonus.SlowlyPaddle#activate()
     */
    @Override
